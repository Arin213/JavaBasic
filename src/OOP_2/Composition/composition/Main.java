...
/**Composition
 ...
 getLamp() which returns an object of type Lamp, and makeBed() which
 prints a message that the bed is being made and also calls the make() method in the Bed class.
...
public class Main {
    public static void main(String[] args){
        ...
        Bedroom bedRoom = new Bedroom("Arin", wall1, wall2, wall3, wall4, ceiling, bed, lamp);
        bedRoom.makeBed();
