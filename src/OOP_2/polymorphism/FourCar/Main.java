 ...
 *
 * The other three classes mentioned above are subclasses of Car.
 * These classes have no member variables and the constructor for each will call
 * the parent constructor for object instantiation. Each of these classes will override the three parent methods
 * startEngine, accelerate, and brake. The return messages for these methods should somewhere
