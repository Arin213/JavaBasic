...
A factor of a number is an integer that divides that number wholly (i.e., without leaving a remainder).
...
public class FactorPrinter {
    ...
    public static void printFactors(int number){
        ...
        // loop up to number and check if the "i" is divisible by number then print that "i"
