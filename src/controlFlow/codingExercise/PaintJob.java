...
/** Paint Job
 ...
 1. Write a method named getBucketCount with 4 parameters. The first parameter should be named width of a type double.
 This parameter represents the width of the wall.

 The second parameter should be named height of a type double. This parameter represents the height of the wall.
 ...
 namely width, height, and areaPerBucket (all of a type double).
 ...
 If one of the parameter areas or areaPerBucket is less or equal to 0, the method needs to return -1to indicate an invalid value.
...
//        double NeededBucket = totalArea/ areaPerBucket;
