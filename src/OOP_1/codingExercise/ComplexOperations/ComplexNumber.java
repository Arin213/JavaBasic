package OOP_1.codingExercise.ComplexOperations;
...
public class ComplexNumber {
    ...
    //methods for addition of complex numbers;
    public void add(double real, double imaginary){
        this.real += real;
        this.imaginary += imaginary;

    }
    public void add (ComplexNumber numberAdd){ //number(real , img)
//        this.real += numberAdd.real;
//        this.imaginary += numberAdd.imaginary;
        add(numberAdd.real, numberAdd.imaginary);

    }

    // methods for subtraction of complex numbers;
    public void subtract(double real, double imaginary){
        this.real -= real;
        this.imaginary -= imaginary;
    }
    public void subtract(ComplexNumber numberSub){
//        this.real -= numberSub.real;
//        this.imaginary -= numberSub.imaginary;
        subtract(numberSub.real, numberSub.imaginary);
    }
