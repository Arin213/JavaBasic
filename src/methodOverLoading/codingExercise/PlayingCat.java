...
EXAMPLES OF INPUT/OUTPUT:
    ...
    isCatPlaying(true, 10); should return false since the temperature is not in range 25-45

    isCatPlaying(false, 36); should return false since temperature
    is not in range 25-35 (summer parameter is false)

    isCatPlaying(false, 35); should return true since the temperature is in range 25-35
