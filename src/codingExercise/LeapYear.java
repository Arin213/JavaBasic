...
public class LeapYear {
    ...
    /* To be leap year, year must be divided by 4 but not divisible by 100, however,
       if the year is divisible 4 and 100, then the year also must be divisible by 400 else
       the year won't be regarded as Leap Year.
    * */
